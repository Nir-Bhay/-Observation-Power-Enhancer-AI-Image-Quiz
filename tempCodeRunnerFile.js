...
app.get("/process-image", async (req, res) => {
    try {
        ...
        // Define the prompt
        const prompt = "Analyze the objects and details in this image of a room. Generate 4 challenging and thought-provoking questions that test the user's observation skills. The questions should require the user to notice specific details and think critically about the scene.";
